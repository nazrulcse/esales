...
ActiveRecord::Schema.define(version: 20160611092046) do
  ...
  create_table "sliders", force: :cascade do |t|
    ...
    t.string   "header_bold",  limit: 255
    t.string   "header_small", limit: 255
    t.float    "off",          limit: 24
