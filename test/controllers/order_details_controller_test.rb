...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { discount: @order_detail.discount, order_id: @order_detail.order_id, price: @order_detail.price, total_quantity: @order_detail.total_quantity }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { discount: @order_detail.discount, order_id: @order_detail.order_id, price: @order_detail.price, total_quantity: @order_detail.total_quantity }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
