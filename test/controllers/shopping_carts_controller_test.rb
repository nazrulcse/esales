...
class ShoppingCartsControllerTest < ActionController::TestCase
  ...
  test "should create shopping_cart" do
    assert_difference('ShoppingCart.count') do
      post :create, shopping_cart: { product_id: @shopping_cart.product_id, quantity: @shopping_cart.quantity, total_price: @shopping_cart.total_price }
    end
  ...
  test "should update shopping_cart" do
    patch :update, id: @shopping_cart, shopping_cart: { product_id: @shopping_cart.product_id, quantity: @shopping_cart.quantity, total_price: @shopping_cart.total_price }
    assert_redirected_to shopping_cart_path(assigns(:shopping_cart))
  end
